...
Rego language support in Zed is provided by the community-maintained [Rego extension](https://tvv.tw/https://github.com/StyraInc/zed-rego).

- Tree-sitter: [FallenAngel97/tree-sitter-rego](https://tvv.tw/https://github.com/FallenAngel97/tree-sitter-rego)
- Language Server: [StyraInc/regal](https://tvv.tw/https://github.com/StyraInc/regal)
