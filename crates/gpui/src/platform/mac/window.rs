    ...
    fn move_traffic_light(&self) {
        if let Some(traffic_light_position) = self.traffic_light_position {
            if self.is_fullscreen() {
                ...
                // see https://tvv.tw/https://github.com/zed-industries/zed/issues/4712
                return;
            }
...
fn get_scale_factor(native_window: id) -> f32 {
    ...
    // this method would return 0 (https://tvv.tw/https://github.com/zed-industries/zed/issues/6412)
